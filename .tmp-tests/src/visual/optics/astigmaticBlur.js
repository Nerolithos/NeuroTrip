...
export const applyAstigmaticBlur = (context, image, width, height, optics) => {
    ...
    context.putImageData(typeof ImageData !== 'undefined' && output instanceof ImageData ? output : toImageData(output), 0, 0);
};
