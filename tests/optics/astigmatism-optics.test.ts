...
import { applyAnisotropicBlur, type ImageDataLike } from '../../src/visual/optics/anisotropicBlur.js'
import { prescriptionToAstigmaticKernel } from '../../src/visual/optics/astigmatismModel.js'
import {
  axisAnglesEquivalent,
  prescriptionAxisToImageAngle,
} from '../../src/visual/optics/prescriptionAxis.js'

const angleDiffModuloPi = (left: number, right: number) => {
...
const createSyntheticImage = (width: number, height: number): ImageDataLike => {
