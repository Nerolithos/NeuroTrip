...
import { FearScene } from './scenes/FearScene/FearScene'
...
const AppRoutes = () => {
  ...
  return (
    <Routes>
      ...
      <Route path="/scene/chapter-iv" element={<FearScene />} />
      <Route path="/chapter-iv" element={<Navigate to="/scene/chapter-iv" replace />} />
