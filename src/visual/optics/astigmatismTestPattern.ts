...
const drawSiemensStar = (ctx: CanvasRenderingContext2D, cx: number, cy: number, radius: number) => {
  const spokes = 72
...
const drawSpokeWheel = (ctx: CanvasRenderingContext2D, cx: number, cy: number, radius: number) => {
...
const drawLineFamilies = (ctx: CanvasRenderingContext2D, width: number, height: number) => {
...
const drawDotMatrix = (ctx: CanvasRenderingContext2D, width: number, height: number) => {
...
const drawTextBlocks = (ctx: CanvasRenderingContext2D, width: number, height: number) => {
