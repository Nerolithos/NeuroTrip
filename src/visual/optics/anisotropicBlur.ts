...
const createImageDataLike = (width: number, height: number, data: Uint8ClampedArray): ImageDataLike => {
...
export const toImageData = (image: ImageDataLike): ImageData => {
...
export const applyAnisotropicBlur = (source: ImageDataLike, kernel: AstigmaticKernel): ImageDataLike => {
